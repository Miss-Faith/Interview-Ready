...
class TestComment(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_comment = Comment(pitch_id=12345,pitch_title='Comment for pitches',pitch_comment='This pitch is the best thing since sliced bread',user = self.user_James )
